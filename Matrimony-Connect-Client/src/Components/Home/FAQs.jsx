...
const FAQs = () => {
  ...
  const questionsAnswers = [
    {
      question: "What is Matrimony Connect?",
      answer:
        "Matrimony Connect is a trusted matrimony platform that connects people looking for meaningful relationships and marriage all over the world. We provide a wide range of profiles and services to help you find the perfect match.",
    },
    {
      question: "Is Matrimony Connect Free?",
      answer:
    ...
    },
    {
      ...
      answer:
        "You can reach out to our support team via email at support@matrimonyconnect.com or use the contact form on our website.",
    },
  ];
